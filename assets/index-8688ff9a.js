...
`;function x1(){return $("div",{className:"info-section",children:$(k1,{triggerOnce:!0,duration:2500,direction:"up",children:De("div",{children:[De("div",{className:"info-container",children:[$("h2",{children:"Mer om podden"}),$("p",{children:"Sex som trans är en podcast som utforskar sex och sexualitet från ett transperspektiv. Mandy Rich delar med sig av sina personliga erfarenheter och bjuder in gäster för att diskutera mer djupgående. Podden syftar till att öppna upp en dialog kring sex och relationer, och ge lyssnarna mer kunskap."})]}),De("div",{className:"info-container",children:[$("h2",{children:"Vill höra vad ni tycker"}),$("p",{children:"Har upprättat en röstbrevlåda för er lyssnare som vill lämna synpunkter, tankar eller egna erfarenheter som sen kommer att spelas upp efter varje avsnitt *08 - 702 25 25*"})]}),De("div",{className:"info-container",children:[$("h2",{children:"Kontakt"}),De("p",{children:["Har du frågor, funderingar eller vill komma med förslag på gäster? Hör av dig till mig på ",$("a",{href:"mailto:sexsomtrans@gmail.com?Subject=&Body=",title:"Hello",children:"sexsomtrans@gmail.com"})]})]})]})})})}function E1(){return $("div",{className:"footer",children:De("div",{className:"footer-container",children:[De("div",{className:"podstore-icon-container",children:[$("a",{href:"https://podcasts.apple.com/se/podcast/sex-som-trans/id1682796785",children:$("img",{src:"apple-appstore.svg"})}),$("a",{children:$("img",{src:"google-playstore.svg"})})]}),De("div",{className:"bottom-container",children:[$("div",{className:"socialmedia-container",children:$("a",{href:"https://www.instagram.com/sexsomtrans",children:$("img",{src:"instagram.svg"})})}),De("span",{children:[$("h3",{children:"A PODCAST OF  "}),$("h2",{children:"MANDY RICH"})]})]})]})})}function C1(){return De("div",{className:"App",children:[$(Dp,{}),$(x1,{}),$(E1,{})]})}Jl.createRoot(document.getElementById("root")).render($(Rs.StrictMode,{children:$(C1,{})}));
